...
constexpr char f_dtd_string[] =
		...
		"\t\t\t\t<!ATTLIST analog defvalue CDATA #REQUIRED>\n"
		"\t\t\t\t<!ATTLIST analog specific_name CDATA #IMPLIED>\n"
		"\t\t\t\t<!ATTLIST analog player CDATA #IMPLIED>\n"
		"\t\t\t<!ELEMENT nonanalog EMPTY>\n"
		"\t\t\t\t<!ATTLIST nonanalog mask CDATA #REQUIRED>\n"
		"\t\t\t\t<!ATTLIST nonanalog type CDATA #REQUIRED>\n"
		"\t\t\t\t<!ATTLIST nonanalog defvalue CDATA #REQUIRED>\n"
		"\t\t\t\t<!ATTLIST nonanalog specific_name CDATA #IMPLIED>\n"
		"\t\t\t\t<!ATTLIST nonanalog player CDATA #IMPLIED>\n"
...
// it would be preferable to replace this with a more centrally located
// implementation that allows both enumerator->value and value->enumerator
// access without repeating ourselves.
#define IOPORT_TYPE_STRINGIFY( name ) #name
std::vector<std::string> ioport_type_to_enumerator =
{
	// pseudo-port types
	IOPORT_TYPE_STRINGIFY( IPT_INVALID ),
	IOPORT_TYPE_STRINGIFY( IPT_UNUSED ),
	IOPORT_TYPE_STRINGIFY( IPT_END ),
	IOPORT_TYPE_STRINGIFY( IPT_UNKNOWN ),
	IOPORT_TYPE_STRINGIFY( IPT_PORT ),
	IOPORT_TYPE_STRINGIFY( IPT_DIPSWITCH ),
	IOPORT_TYPE_STRINGIFY( IPT_CONFIG ),

	// start buttons
	IOPORT_TYPE_STRINGIFY( IPT_START1 ),
	IOPORT_TYPE_STRINGIFY( IPT_START2 ),
	IOPORT_TYPE_STRINGIFY( IPT_START3 ),
	IOPORT_TYPE_STRINGIFY( IPT_START4 ),
	IOPORT_TYPE_STRINGIFY( IPT_START5 ),
	IOPORT_TYPE_STRINGIFY( IPT_START6 ),
	IOPORT_TYPE_STRINGIFY( IPT_START7 ),
	IOPORT_TYPE_STRINGIFY( IPT_START8 ),
	IOPORT_TYPE_STRINGIFY( IPT_START9 ),
	IOPORT_TYPE_STRINGIFY( IPT_START10 ),

	// coin slots
	IOPORT_TYPE_STRINGIFY( IPT_COIN1 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN2 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN3 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN4 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN5 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN6 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN7 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN8 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN9 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN10 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN11 ),
	IOPORT_TYPE_STRINGIFY( IPT_COIN12 ),
	IOPORT_TYPE_STRINGIFY( IPT_BILL1 ),

	// service coin
	IOPORT_TYPE_STRINGIFY( IPT_SERVICE1 ),
	IOPORT_TYPE_STRINGIFY( IPT_SERVICE2 ),
	IOPORT_TYPE_STRINGIFY( IPT_SERVICE3 ),
	IOPORT_TYPE_STRINGIFY( IPT_SERVICE4 ),

	// tilt inputs
	IOPORT_TYPE_STRINGIFY( IPT_TILT1 ),
	IOPORT_TYPE_STRINGIFY( IPT_TILT2 ),
	IOPORT_TYPE_STRINGIFY( IPT_TILT3 ),
	IOPORT_TYPE_STRINGIFY( IPT_TILT4 ),

	// misc other digital inputs
	IOPORT_TYPE_STRINGIFY( IPT_POWER_ON ),
	IOPORT_TYPE_STRINGIFY( IPT_POWER_OFF ),
	IOPORT_TYPE_STRINGIFY( IPT_SERVICE ),
	IOPORT_TYPE_STRINGIFY( IPT_TILT ),
	IOPORT_TYPE_STRINGIFY( IPT_INTERLOCK ),
	IOPORT_TYPE_STRINGIFY( IPT_MEMORY_RESET ),
	IOPORT_TYPE_STRINGIFY( IPT_VOLUME_UP ),
	IOPORT_TYPE_STRINGIFY( IPT_VOLUME_DOWN ),
	IOPORT_TYPE_STRINGIFY( IPT_START ),              // use the numbered start button(s) for coin-ops
	IOPORT_TYPE_STRINGIFY( IPT_SELECT ),
	IOPORT_TYPE_STRINGIFY( IPT_KEYPAD ),
	IOPORT_TYPE_STRINGIFY( IPT_KEYBOARD ),

	// digital joystick inputs
	IOPORT_TYPE_STRINGIFY( IPT_DIGITAL_JOYSTICK_FIRST ),

		// use IOPORT_TYPE_STRINGIFY( IPT_JOYSTICK for panels where the player has one single joystick
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICK_UP ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICK_DOWN ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICK_LEFT ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICK_RIGHT ),

		// use IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKLEFT and IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKRIGHT for dual joystick panels
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKRIGHT_UP ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKRIGHT_DOWN ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKRIGHT_LEFT ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKRIGHT_RIGHT ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKLEFT_UP ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKLEFT_DOWN ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKLEFT_LEFT ),
		IOPORT_TYPE_STRINGIFY( IPT_JOYSTICKLEFT_RIGHT ),

	IOPORT_TYPE_STRINGIFY( IPT_DIGITAL_JOYSTICK_LAST ),

	// action buttons
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON1 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON2 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON3 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON4 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON5 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON6 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON7 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON8 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON9 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON10 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON11 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON12 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON13 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON14 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON15 ),
	IOPORT_TYPE_STRINGIFY( IPT_BUTTON16 ),

	// mahjong inputs
	IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_FIRST ),

		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_A ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_B ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_C ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_D ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_E ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_F ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_G ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_H ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_I ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_J ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_K ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_L ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_M ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_N ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_O ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_P ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_Q ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_KAN ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_PON ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_CHI ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_REACH ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_RON ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_FLIP_FLOP ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_BET ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_SCORE ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_DOUBLE_UP ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_BIG ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_SMALL ),
		IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_LAST_CHANCE ),

	IOPORT_TYPE_STRINGIFY( IPT_MAHJONG_LAST ),

	// hanafuda inputs
	IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_FIRST ),

		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_A ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_B ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_C ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_D ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_E ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_F ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_G ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_H ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_YES ),
		IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_NO ),

	IOPORT_TYPE_STRINGIFY( IPT_HANAFUDA_LAST ),

	// gambling inputs
	IOPORT_TYPE_STRINGIFY( IPT_GAMBLING_FIRST ),

		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_KEYIN ),   // attendant
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_KEYOUT ),  // attendant
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_SERVICE ), // attendant
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_BOOK ),    // attendant
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_DOOR ),    // attendant
	//  IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_DOOR2 ),   // many gambling games have several doors.
	//  IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_DOOR3 ),
	//  IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_DOOR4 ),
	//  IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_DOOR5 ),

		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_PAYOUT ),  // player
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_BET ),     // player
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_DEAL ),    // player
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_STAND ),   // player
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_TAKE ),    // player
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_D_UP ),    // player
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_HALF ),    // player
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_HIGH ),    // player
		IOPORT_TYPE_STRINGIFY( IPT_GAMBLE_LOW ),     // player

		// poker-specific inputs
		IOPORT_TYPE_STRINGIFY( IPT_POKER_HOLD1 ),
		IOPORT_TYPE_STRINGIFY( IPT_POKER_HOLD2 ),
		IOPORT_TYPE_STRINGIFY( IPT_POKER_HOLD3 ),
		IOPORT_TYPE_STRINGIFY( IPT_POKER_HOLD4 ),
		IOPORT_TYPE_STRINGIFY( IPT_POKER_HOLD5 ),
		IOPORT_TYPE_STRINGIFY( IPT_POKER_CANCEL ),

		// slot-specific inputs
		IOPORT_TYPE_STRINGIFY( IPT_SLOT_STOP1 ),
		IOPORT_TYPE_STRINGIFY( IPT_SLOT_STOP2 ),
		IOPORT_TYPE_STRINGIFY( IPT_SLOT_STOP3 ),
		IOPORT_TYPE_STRINGIFY( IPT_SLOT_STOP4 ),
		IOPORT_TYPE_STRINGIFY( IPT_SLOT_STOP_ALL ),

	IOPORT_TYPE_STRINGIFY( IPT_GAMBLING_LAST ),

	// analog inputs
	IOPORT_TYPE_STRINGIFY( IPT_ANALOG_FIRST ),

		IOPORT_TYPE_STRINGIFY( IPT_ANALOG_ABSOLUTE_FIRST ),

			IOPORT_TYPE_STRINGIFY( IPT_AD_STICK_X ),     // absolute // autocenter
			IOPORT_TYPE_STRINGIFY( IPT_AD_STICK_Y ),     // absolute // autocenter
			IOPORT_TYPE_STRINGIFY( IPT_AD_STICK_Z ),     // absolute // autocenter
			IOPORT_TYPE_STRINGIFY( IPT_PADDLE ),         // absolute // autocenter
			IOPORT_TYPE_STRINGIFY( IPT_PADDLE_V ),       // absolute // autocenter
			IOPORT_TYPE_STRINGIFY( IPT_PEDAL ),          // absolute // autocenter
			IOPORT_TYPE_STRINGIFY( IPT_PEDAL2 ),         // absolute // autocenter
			IOPORT_TYPE_STRINGIFY( IPT_PEDAL3 ),         // absolute // autocenter
			IOPORT_TYPE_STRINGIFY( IPT_LIGHTGUN_X ),     // absolute
			IOPORT_TYPE_STRINGIFY( IPT_LIGHTGUN_Y ),     // absolute
			IOPORT_TYPE_STRINGIFY( IPT_POSITIONAL ),     // absolute // autocenter if not wraps
			IOPORT_TYPE_STRINGIFY( IPT_POSITIONAL_V ),   // absolute // autocenter if not wraps

		IOPORT_TYPE_STRINGIFY( IPT_ANALOG_ABSOLUTE_LAST ),

		IOPORT_TYPE_STRINGIFY( IPT_DIAL ),           // relative
		IOPORT_TYPE_STRINGIFY( IPT_DIAL_V ),         // relative
		IOPORT_TYPE_STRINGIFY( IPT_TRACKBALL_X ),    // relative
		IOPORT_TYPE_STRINGIFY( IPT_TRACKBALL_Y ),    // relative
		IOPORT_TYPE_STRINGIFY( IPT_MOUSE_X ),        // relative
		IOPORT_TYPE_STRINGIFY( IPT_MOUSE_Y ),        // relative

	IOPORT_TYPE_STRINGIFY( IPT_ANALOG_LAST ),

	// analog adjuster support
	IOPORT_TYPE_STRINGIFY( IPT_ADJUSTER ),

	// the following are special codes for user interface handling - not to be used by drivers!
	IOPORT_TYPE_STRINGIFY( IPT_UI_FIRST ),

		IOPORT_TYPE_STRINGIFY( IPT_UI_CONFIGURE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_ON_SCREEN_DISPLAY ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_DEBUG_BREAK ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_PAUSE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_PAUSE_SINGLE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_REWIND_SINGLE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_RESET_MACHINE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_SOFT_RESET ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_SHOW_GFX ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_FRAMESKIP_DEC ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_FRAMESKIP_INC ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_THROTTLE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_FAST_FORWARD ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_SHOW_FPS ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_SNAPSHOT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_RECORD_MNG ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_RECORD_AVI ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_TOGGLE_CHEAT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_UP ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_DOWN ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_LEFT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_RIGHT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_HOME ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_END ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_PAGE_UP ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_PAGE_DOWN ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_FOCUS_NEXT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_FOCUS_PREV ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_SELECT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_CANCEL ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_DISPLAY_COMMENT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_CLEAR ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_ZOOM_IN ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_ZOOM_OUT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_ZOOM_DEFAULT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_PREV_GROUP ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_NEXT_GROUP ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_ROTATE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_SHOW_PROFILER ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_TOGGLE_UI ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_RELEASE_POINTER ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_PASTE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_SAVE_STATE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_LOAD_STATE ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_TAPE_START ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_TAPE_STOP ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_DATS ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_FAVORITES ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_EXPORT ),
		IOPORT_TYPE_STRINGIFY( IPT_UI_AUDIT ),

		// additional OSD-specified UI port types (up to 16)
		IOPORT_TYPE_STRINGIFY( IPT_OSD_1 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_2 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_3 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_4 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_5 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_6 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_7 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_8 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_9 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_10 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_11 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_12 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_13 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_14 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_15 ),
		IOPORT_TYPE_STRINGIFY( IPT_OSD_16 ),

	IOPORT_TYPE_STRINGIFY( IPT_UI_LAST ),

	IOPORT_TYPE_STRINGIFY( IPT_OTHER ), // not mapped to standard defaults

	IOPORT_TYPE_STRINGIFY( IPT_SPECIAL ), // uninterpreted characters
	IOPORT_TYPE_STRINGIFY( IPT_CUSTOM ), // handled by custom code
	IOPORT_TYPE_STRINGIFY( IPT_OUTPUT ),

	IOPORT_TYPE_STRINGIFY( IPT_COUNT )
};
...
void output_ports(std::ostream &out, const ioport_list &portlist)
{
	std::string field_specific_name;
	std::string field_player;
	...
	for (auto &port : portlist)
	{
		...
		for (ioport_field const &field : port.second->fields())
		{
			...
			if (field.specific_name() != nullptr)
				field_specific_name = util::string_format(" specific_name=\"%s\" ", normalize_string(field.specific_name()));

			field_player = "";
			if (field.type() >= IPT_START && field.type() < IPT_ANALOG_LAST)
				field_player = util::string_format(" player=\"%u\" ", field.player());

			if (field.is_analog())
			{
				util::stream_format(out, "\t\t\t<analog mask=\"%u\" type=\"%s\" defvalue=\"%u\"%s%s/>\n", field.mask(), ioport_type_to_enumerator.at(field.type()), field.defvalue(), field_specific_name, field_player);
			}
			else
			{
				util::stream_format(out, "\t\t\t<nonanalog mask=\"%u\" type=\"%s\" defvalue=\"%u\"%s%s/>\n", field.mask(), ioport_type_to_enumerator.at(field.type()), field.defvalue(), field_specific_name, field_player);
			}
		}
